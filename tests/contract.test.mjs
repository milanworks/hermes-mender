...
assert.match(source, /agentExpected/)
assert.match(source, /desktopExpected/)
assert.match(source, /uninstall\.tombstones/)
assert.match(source, /syncIntentionalAgentRemovals/)
assert.match(source, /uninstall-synced/)
